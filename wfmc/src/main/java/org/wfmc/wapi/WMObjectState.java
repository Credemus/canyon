...
public abstract class WMObjectState implements Serializable {
    static final long serialVersionUID = 3506741109231223508L;
    ...
    public final WMObjectState[] getStates() {
        if (_allowedStatesList == null) {
            final int[] thisState = getStatesByAction();
     ...
     * @return State code.
     * @throws WMTransitionNotAllowedException if the specified action is
     ...
     * would be illegal.
     * @return Action code.
     * @throws WMTransitionNotAllowedException if a transition from the current
    ...
    public final int checkTransition(WMObjectState newState,
        ...
        return checkTransition(newState.intValue(), throwException);
    }
