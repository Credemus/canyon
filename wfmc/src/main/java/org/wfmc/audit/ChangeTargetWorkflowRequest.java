 ...
 * @author Antony Lodge
 */
public class ChangeTargetWorkflowRequest extends TargetWorkflow {
    static final long serialVersionUID = 5909489844768004913L;

    private String sourceRequestedState;

    public ChangeTargetWorkflowRequest() {
    }
     ...
     */
    public ChangeTargetWorkflowRequest(CWADPrefix cwadPrefix,
    ...
    public ChangeTargetWorkflowRequest(CWADPrefix cwadPrefix,
        ...
        String sourceRoleId, String sourceProcessDefinitionId,
        String sourceProcessDefinitionBusinessName,
        String sourceActivityDefinitionBusinessName, String sourceRequestedState) {
    ...
    public String toString() {
        return "ChangeTargetWorkflowRequest@" +
