 ...
 * @author junglas
 */
public class Limit2Test extends WetdockTestBase
{

  public Limit2Test( String testName, TestContext context )
  {
  ...
  public void testCreatePackage()
      throws Exception
  {
    createPackage( "limit2.xpdl" );
  }

  public void testStartProcess()
      throws Exception
  {
    startProcess( "Limit2_Wor1", null );
  }
  ...
  public static TestSuite suite()
  {
    ...
    suite.addTest( new Limit2Test( "testClearRepositories", context ) );
    suite.addTest( new Limit2Test( "testCreateUsersAndRoles", context ) );
    suite.addTest( new Limit2Test( "testCreatePackage", context ) );

    suite.addTest( new Limit2Test( "testStartProcess", context ) );
    suite.addTest( new Limit2Test( "testCompleteWorkItem1", context ) );
    suite.addTest( new Limit2Test( "testCheckProcessCompleted", context ));
    
    suite.addTest( new Limit2Test( "testStartProcess", context ) );
    suite.addTest( new Limit2Test( "testCheckWorkItem1AndWait", context ));
    suite.addTest( new Limit2Test( "testCompleteWorkItem1", context ) );
    suite.addTest( new Limit2Test( "testCheckProcessCompleted", context ));
    suite.addTest( new Limit2Test( "testCheckLimitExceededProcess", context ));
    suite.addTest( new Limit2Test( "testCompleteWorkItemLimitActivity", context ) );
    suite.addTest( new Limit2Test( "testCheckProcessCompleted", context ));
