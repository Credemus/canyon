 ...
 * @author junglas
 */
public class SubprocessLoopTest extends WetdockTestBase {
  public SubprocessLoopTest(String testName, TestContext context) {
  ...
  public void testSubprocessLoop() throws Exception {
    testClearRepositories();
    testCreateUsersAndRoles();    
    createPackage("subprocessLoop.xpdl");
    startProcess("SubprocessLoop", null);
  ...
  public static TestSuite suite() {
    ...
    suite.addTest(new SubprocessLoopTest("testSubprocessLoop", context));
