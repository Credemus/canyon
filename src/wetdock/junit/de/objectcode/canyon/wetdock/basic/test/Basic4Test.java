 ...
 * @author junglas
 */
public class Basic4Test extends WetdockTestBase
{
  public Basic4Test( String testName, TestContext context )
  {
  ...
  public void testCreatePackage()
      throws Exception
  {
    createPackage( "basic4.xpdl" );
  }

  public void testStartProcess()
      throws Exception
  {
    startProcess( "basic4_Wor1", null );
  }
      ...
      throws Exception
  {
    ...
    appData[0].getParameters()[2].setValue("out");
      ...
      throws Exception
  {
    ...
    assertEquals("ProcessAttr 2 value", "Initial Param2", attrs[1].getValue().toString());
    assertEquals("ProcessAttr 3 name", "param3", attrs[2].getName());    
    assertEquals("ProcessAttr 3 value", "out", attrs[2].getValue().toString());
  }
  ...
  {
    TestSuite suite = new TestSuite( "Basic4 Test" );
    TestContext context = new TestContext();

    suite.addTest( new Basic4Test( "testClearRepositories", context ) );
    suite.addTest( new Basic4Test( "testCreateUsersAndRoles", context ) );
    suite.addTest( new Basic4Test( "testCreatePackage", context ) );
    suite.addTest( new Basic4Test( "testStartProcess", context ) );
    
    // Loop 1
    suite.addTest( new Basic4Test( "testCheckProcessData1", context ));
    suite.addTest( new Basic4Test( "testCompleteWorkItem1a", context ));
    suite.addTest( new Basic4Test( "testCheckProcessData2a", context ));
    suite.addTest( new Basic4Test( "testCompleteWorkItem2", context ));
    suite.addTest( new Basic4Test( "testCompleteWorkItem3", context ));
    suite.addTest( new Basic4Test( "testCompleteWorkItem4", context ));

    // Loop 2 (2 and 3 reverted )
    suite.addTest( new Basic4Test( "testCompleteWorkItem1a", context ));
    suite.addTest( new Basic4Test( "testCheckProcessData2a", context ));
    suite.addTest( new Basic4Test( "testCompleteWorkItem3", context ));
    suite.addTest( new Basic4Test( "testCompleteWorkItem2", context ));
    ...
    // Final Loop
    suite.addTest( new Basic4Test( "testCompleteWorkItem1b", context ));
    suite.addTest( new Basic4Test( "testCheckProcessData2b", context ));
    suite.addTest( new Basic4Test( "testCompleteWorkItem2", context ));
    suite.addTest( new Basic4Test( "testCompleteWorkItem3", context ));
    suite.addTest( new Basic4Test( "testCompleteWorkItem4", context ));

    suite.addTest( new Basic4Test( "testCheckProcessCompleted", context ) );
