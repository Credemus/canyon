/* Generated By:JavaCC: Do not edit this line. SQLQueryParserTokenManager.java */
package de.objectcode.canyon.engine.util;

public class SQLQueryParserTokenManager implements SQLQueryParserConstants
{
...
private final int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 43:
         return jjStartNfaWithStates_0(0, 128, 43);
      case 44:
   ...
   switch(curChar)
   {
      ...
      case 100:
         if ((active0 & 0x100L) != 0L)
            ...
            return jjStartNfaWithStates_0(2, 22, 44);
      ...
      case 116:
         if ((active0 & 0x200000000L) != 0L)
            ...
            return jjStartNfaWithStates_0(2, 84, 44);
   ...
   switch(curChar)
   {
      ...
      case 110:
         if ((active0 & 0x200000000000L) != 0L)
            ...
            return jjStartNfaWithStates_0(3, 90, 44);
...
private final int jjMoveStringLiteralDfa5_0(long old0, long active0, long old1, long active1)
{
   ...
   switch(curChar)
   {
      ...
      case 104:
         if ((active1 & 0x20L) != 0L)
            return jjStartNfaWithStates_0(5, 69, 44);
         break;
      case 105:
      ...
      case 115:
         if ((active0 & 0x40000000000L) != 0L)
            ...
            return jjStartNfaWithStates_0(5, 89, 44);
   ...
   switch(curChar)
   {
      ...
      case 101:
         if ((active1 & 0x200L) != 0L)
            ...
            return jjStartNfaWithStates_0(6, 94, 44);
      ...
      case 110:
         if ((active0 & 0x800L) != 0L)
            ...
            return jjStartNfaWithStates_0(6, 12, 44);
   ...
   switch(curChar)
   {
      ...
      case 116:
         if ((active0 & 0x10000L) != 0L)
            ...
            return jjStartNfaWithStates_0(7, 41, 44);
   ...
   switch(curChar)
   {
      ...
      case 110:
         if ((active0 & 0x800000000000000L) != 0L)
            return jjStartNfaWithStates_0(8, 59, 44);
         return jjMoveStringLiteralDfa9_0(active0, 0L, active1, 0x1L);
      case 114:
         if ((active0 & 0x8000L) != 0L)
            return jjStartNfaWithStates_0(8, 15, 44);
...
private final int jjMoveStringLiteralDfa9_0(long old0, long active0, long old1, long active1)
{
   ...
   switch(curChar)
   {
      ...
      case 115:
         if ((active1 & 0x8000L) != 0L)
            return jjStartNfaWithStates_0(9, 79, 44);
         break;
      case 116:
...
private final int jjMoveStringLiteralDfa14_0(long old0, long active0, long old1, long active1)
{
   ...
   switch(curChar)
   {
      ...
      case 114:
         if ((active1 & 0x800000000L) != 0L)
            return jjStartNfaWithStates_0(14, 99, 44);
         break;
      case 116:
         if ((active1 & 0x200000L) != 0L)
...
private final int jjMoveStringLiteralDfa16_0(long old0, long active0, long old1, long active1)
{
   ...
   switch(curChar)
   {
      ...
      case 114:
         if ((active0 & 0x4000000000000000L) != 0L)
            return jjStartNfaWithStates_0(16, 62, 44);
         break;
      case 117:
...
private final int jjMoveStringLiteralDfa18_0(long old0, long active0, long old1, long active1)
{
   ...
   switch(curChar)
   {
      ...
      case 112:
         if ((active1 & 0x1L) != 0L)
            return jjStartNfaWithStates_0(18, 64, 44);
         else if ((active1 & 0x20000L) != 0L)
            return jjStartNfaWithStates_0(18, 81, 44);
         break;
      case 116:
...
private final int jjMoveStringLiteralDfa21_0(long old0, long active0, long old1, long active1)
{
   ...
   switch(curChar)
   {
      ...
      case 101:
         if ((active0 & 0x80000000000000L) != 0L)
            return jjStartNfaWithStates_0(21, 55, 44);
...
private final int jjMoveStringLiteralDfa23_0(long old0, long active0, long old1, long active1)
{
   ...
   switch(curChar)
   {
      ...
      case 103:
         if ((active0 & 0x8000000000000000L) != 0L)
            return jjStartNfaWithStates_0(23, 63, 44);
         break;
      default :
         break;
   }
...
static final long[] jjtoToken = {
   0xffffffffffffff81L, 0xffffcdffffffffffL, 0xfL, 
};
...
public SQLQueryParserTokenManager(SimpleCharStream stream)
{
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public SQLQueryParserTokenManager(SimpleCharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
