...
public class CountQueryBuilder implements IFilterBuilder
{
    ...
    throws HibernateException
  {
    ...
    final StringBuffer postQuery = new StringBuffer(" and ( ");
  ...
  {
    m_stack.addLast( "( o." + attribute + " >= :p_" + attribute + " and o." + attribute + " <= :p_" + attribute + " )" );
    m_binds.add( new Bind(attribute,  Hibernate.DOUBLE, new Double( value1 ) ) );
    m_binds.add( new Bind(attribute,  Hibernate.DOUBLE, new Double( value2 ) ) );
  }
  ...
  {
    m_stack.addLast( "( o." + attribute + " >= :p_" + attribute + " and o." + attribute + " <= :p_" + attribute + " )" );
    m_binds.add( new Bind(attribute,  Hibernate.INTEGER, new Integer( value1 ) ) );
    m_binds.add( new Bind(attribute,  Hibernate.INTEGER, new Integer( value2 ) ) );
  }
  ...
  public void compareExpr( String attribute, int operation, boolean value )
  {
    ...
    m_binds.add( new Bind(attribute,  Hibernate.BOOLEAN, new Boolean( value ) ) );
  }
  ...
  {
    m_stack.addLast( "o." + attribute + " " + g_operators[operation] + " :p_" + attribute + "" );
    m_binds.add( new Bind(attribute,  Hibernate.DOUBLE, new Double( value ) ) );
  }
  ...
  {
    m_stack.addLast( "o." + attribute + " " + g_operators[operation] + " :p_" + attribute + "" );
    m_binds.add( new Bind(attribute, Hibernate.INTEGER, new Integer( value ) ) );
  }
  ...
  {
    m_stack.addLast( "o." + attribute + " " + g_operators[operation] + " :p_" + attribute + "" );
    m_binds.add( new Bind(attribute, Hibernate.LONG, new Long( value ) ) );
  }
