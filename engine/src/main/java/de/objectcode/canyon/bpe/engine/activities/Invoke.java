...
import de.objectcode.canyon.bpe.engine.correlation.*;
...
public class Invoke extends Activity {
  ...
  private List<CorrelationDefinition> m_correlations;
    ...
    if (m_connector != null) {
      ...
      if (inMessage != null) {
        ...
        if (!m_correlations.isEmpty()) {
          ...
          for (CorrelationDefinition correlation : m_correlations) {
