...
public class ActivitySet implements IActivityContainer, IValidatable, Serializable {
  ...
  private String m_id;
  private Map<String, Activity> m_activities;
  private Map<String, Transition> m_transitions;
   ...
   */
  public ActivitySet() {
    m_activities = new HashMap<String, Activity>();
    m_transitions = new HashMap<String, Transition>();
  }
